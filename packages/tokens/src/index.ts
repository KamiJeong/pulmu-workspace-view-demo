...
export const primitiveTokens = {
  color: {
    ...
    theme: {
      light: {
        ...
        surfaceRaised: token("--pulmu-color-light-surface-raised", "#FFFFFF", "Raised ivory surface", "Light theme bounded raised surfaces"),
        surfaceInset: token("--pulmu-color-light-surface-inset", "#ECEDEA", "Inset ivory surface", "Light theme pressed controls and wells"),
        surfaceOverlay: token("--pulmu-color-light-surface-overlay", "#FFFFFF", "Overlay ivory surface", "Light theme floating layers"),
      ...
      dark: {
        ...
        surfaceRaised: token("--pulmu-color-dark-surface-raised", "#1D2125", "Raised coal surface", "Dark theme bounded raised surfaces"),
        surfaceInset: token("--pulmu-color-dark-surface-inset", "#111315", "Inset coal surface", "Dark theme pressed controls and wells"),
        surfaceOverlay: token("--pulmu-color-dark-surface-overlay", "#24292E", "Overlay coal surface", "Dark theme floating layers"),
  ...
  shadow: {
    lightRaised: token("--pulmu-shadow-light-raised", "6px 6px 14px rgb(27 29 31 / 0.12), -6px -6px 14px rgb(255 255 255 / 0.9)", "Light raised depth", "Theme source for bounded raised surfaces"),
    lightInset: token("--pulmu-shadow-light-inset", "inset 3px 3px 7px rgb(27 29 31 / 0.12), inset -3px -3px 7px rgb(255 255 255 / 0.82)", "Light inset depth", "Theme source for pressed controls and wells"),
    lightOverlay: token("--pulmu-shadow-light-overlay", "0 16px 40px rgb(27 29 31 / 0.22)", "Light overlay depth", "Theme source for floating layers"),
    darkRaised: token("--pulmu-shadow-dark-raised", "6px 6px 14px rgb(0 0 0 / 0.48), -4px -4px 12px rgb(58 65 71 / 0.2)", "Dark raised depth", "Theme source for bounded raised surfaces"),
    darkInset: token("--pulmu-shadow-dark-inset", "inset 3px 3px 7px rgb(0 0 0 / 0.48), inset -3px -3px 7px rgb(58 65 71 / 0.16)", "Dark inset depth", "Theme source for pressed controls and wells"),
    darkOverlay: token("--pulmu-shadow-dark-overlay", "0 16px 40px rgb(0 0 0 / 0.56)", "Dark overlay depth", "Theme source for floating layers"),
    sm: token("--pulmu-shadow-sm", "0 1px 2px rgb(0 0 0 / 0.35)", "Deprecated small shadow", "Compatibility only; use semantic raised shadow"),
    md: token("--pulmu-shadow-md", "0 8px 24px rgb(0 0 0 / 0.4)", "Deprecated medium shadow", "Compatibility only; use semantic overlay shadow"),
  },
  opacity: {
...
export const semanticTokens = {
  color: {
    ...
    surfaceRaised: token("--pulmu-color-surface-raised", "var(--pulmu-color-dark-surface-raised)", "Raised surface", "Bounded cards and secondary interactive surfaces"),
    surfaceInset: token("--pulmu-color-surface-inset", "var(--pulmu-color-dark-surface-inset)", "Inset surface", "Pressed controls and input-like wells"),
    surfaceOverlay: token("--pulmu-color-surface-overlay", "var(--pulmu-color-dark-surface-overlay)", "Overlay surface", "Menus, popovers, and dialogs"),
    surfaceElevated: token("--pulmu-color-surface-elevated", "var(--pulmu-color-surface-subtle)", "Deprecated elevated surface alias", "Legacy surfaceSubtle compatibility; new depth consumers use surfaceRaised"),
  ...
  radius: {
    ...
    pill: token("--pulmu-radius-pill", "var(--pulmu-radius-full)", "Pill radius", "Badges and explicitly pill-shaped controls"),
  },
  border: {
  ...
  motion: {
    ...
    elevationDuration: token("--pulmu-motion-elevation-duration", "var(--pulmu-motion-duration-fast)", "Elevation motion", "Shadow and surface state transitions"),
    elevationEasing: token("--pulmu-motion-elevation-easing", "var(--pulmu-motion-easing-standard)", "Elevation easing", "Shadow and surface state transitions"),
  },
